...
public class StringMethodDemo {
    ...
    public static void method_sub()
    {
        ...
        sop(s.substring(2));//从指定位置开始到结尾。如果角标越界，会出现字符串角标越界异常
    ...
    public static void method_trans()
    {
        ...
        String s = new String(arr,1,3);//bcd
        sop("s="+s);
    ...
    public static void method_get(){
        ...
        //根据索引获取字符
        sop(str.charAt(4));//当访问到字符串中不存在的角标时会发生StringIndexOutOfBoundsException。角标越界异常
